...
// dovrebbe funzionare uguale speriamo
// sicuro una di queste due funzioni si può eliminare, quella con k è per tutti
// i boids mentre l'altra è già per i vicini
